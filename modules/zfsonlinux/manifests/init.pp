class zfsonlinux ( $version ) {
    
    $baseurl = "http://github.com/downloads/zfsonlinux"
    #$version = "0.6.0-rc12" # support dkms (module will be automatically rebuilt when your kernel is updated)
    ...
    # Already installed by basci_package module:
    #gcc
    #make
    #wget
    #kernel-devel
    ...
    exec { "get spl": #keep in files
        ...
        require => Package[$zfsdep, "rpm-build", "dkms"],
    }
    exec { "unzip spl":
